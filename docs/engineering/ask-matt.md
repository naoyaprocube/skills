...
- **Standalones**, off every flow, reached for on their own terms: the prototype, the questionnaire, [presentation-prep](https://aihero.dev/skills-presentation-prep) before facing audience questions, or the merge conflict you are already sitting in.
