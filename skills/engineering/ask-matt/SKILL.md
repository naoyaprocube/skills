...
- **`/presentation-prep`** rehearses the questions an audience is likely to ask after a product explanation, demo, or presentation. It checks free-text answers, explains gaps, and moves through an audience-question queue. Use it when the idea is already prepared and the risk is whether you can explain it under questioning. Use `/grill-me` instead when the idea itself still needs sharpening.
